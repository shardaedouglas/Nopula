...
2. Type "Saasify" in the search field.
...
* Add: Missing flow block font
* Fix: Dark mode toggle
* Update: Change font to Figtree
* Update: Simplify block patterns
* Update: Use customizable colors for gradient
* Update: Screenshot to match new design
* Remove: Marquee from home page
